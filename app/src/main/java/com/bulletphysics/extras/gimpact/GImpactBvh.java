...
class GImpactBvh {
	...
	protected com.bulletphysics.extras.gimpact.BvhTree box_tree = new com.bulletphysics.extras.gimpact.BvhTree();
	protected com.bulletphysics.extras.gimpact.PrimitiveManagerBase primitive_manager;
	 ...
	 * This constructor doesn't build the tree. you must call buildSet.
	 */
	public GImpactBvh(com.bulletphysics.extras.gimpact.PrimitiveManagerBase primitive_manager) {
	...
	public void setPrimitiveManager(com.bulletphysics.extras.gimpact.PrimitiveManagerBase primitive_manager) {
		this.primitive_manager = primitive_manager;
	}

	public com.bulletphysics.extras.gimpact.PrimitiveManagerBase getPrimitiveManager() {
	...
	public void buildSet() {
		...
		com.bulletphysics.extras.gimpact.BvhDataArray primitive_boxes = new com.bulletphysics.extras.gimpact.BvhDataArray();
	...
	public com.bulletphysics.extras.gimpact.BvhTreeNodeArray get_node_pointer() {
		return box_tree.get_node_pointer();
	}

	private static boolean _node_collision(com.bulletphysics.extras.gimpact.GImpactBvh boxset0, com.bulletphysics.extras.gimpact.GImpactBvh boxset1, BoxBoxTransformCache trans_cache_1to0, int node0, int node1, boolean complete_primitive_tests) {
		AABB box0 = new AABB();
	 ...
	 */
	private static void _find_collision_pairs_recursive(com.bulletphysics.extras.gimpact.GImpactBvh boxset0, com.bulletphysics.extras.gimpact.GImpactBvh boxset1, com.bulletphysics.extras.gimpact.PairSet collision_pairs, BoxBoxTransformCache trans_cache_1to0, int node0, int node1, boolean complete_primitive_tests) {
		if (_node_collision(
	...
	public static void find_collision(com.bulletphysics.extras.gimpact.GImpactBvh boxset0, Transform trans0, com.bulletphysics.extras.gimpact.GImpactBvh boxset1, Transform trans1, com.bulletphysics.extras.gimpact.PairSet collision_pairs) {
