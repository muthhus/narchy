...
public class TriangleContact {
	...
	public TriangleContact(com.bulletphysics.extras.gimpact.TriangleContact other) {
		copy_from(other);
	}

	public void set(com.bulletphysics.extras.gimpact.TriangleContact other) {
		copy_from(other);
	}
	
	public void copy_from(com.bulletphysics.extras.gimpact.TriangleContact other) {
