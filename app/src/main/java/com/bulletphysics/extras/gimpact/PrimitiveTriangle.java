...
public class PrimitiveTriangle {
	...
	public void set(com.bulletphysics.extras.gimpact.PrimitiveTriangle tri) {
	 ...
	 */
	public boolean overlap_test_conservative(com.bulletphysics.extras.gimpact.PrimitiveTriangle other) {
	 ...
	 */
	public int clip_triangle(com.bulletphysics.extras.gimpact.PrimitiveTriangle other, ObjectArrayList<Vector3f> clipped_points) {
		// edge 0
	 ...
	 */
	public boolean find_triangle_collision_clip_method(com.bulletphysics.extras.gimpact.PrimitiveTriangle other, TriangleContact contacts) {
