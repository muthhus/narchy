...
public class GImpactMeshShapePart extends GImpactShapeInterface {
	...
	com.bulletphysics.extras.gimpact.TrimeshPrimitiveManager primitive_manager = new com.bulletphysics.extras.gimpact.TrimeshPrimitiveManager();
	...
	public void lockChildShapes() {
		com.bulletphysics.extras.gimpact.TrimeshPrimitiveManager dummymanager = (com.bulletphysics.extras.gimpact.TrimeshPrimitiveManager) box_set.getPrimitiveManager();
		dummymanager.lock();
	}
	...
	@Override
    com.bulletphysics.extras.gimpact.PrimitiveManagerBase getPrimitiveManager() {
		return primitive_manager;
	}

	com.bulletphysics.extras.gimpact.TrimeshPrimitiveManager getTrimeshPrimitiveManager() {
		return primitive_manager;
	}
	...
	public void calculateLocalInertia(float mass, Vector3f inertia) {
		...
		while ((i--) != 0) {
			...
			com.bulletphysics.extras.gimpact.GImpactMassUtil.get_point_inertia(pointintertia, pointmass, pointintertia);
	...
	@Override
	void getBulletTetrahedron( int prim_index, com.bulletphysics.extras.gimpact.TetrahedronShapeEx tetrahedron) {
		assert (false);
	}
