...
public class Transform {
	...
	public Transform(com.bulletphysics.linearmath.Transform tr) {
		set(tr);
	}
	
	public void set(com.bulletphysics.linearmath.Transform tr) {
		basis.set(tr.basis);
	...
	public void inverse(com.bulletphysics.linearmath.Transform tr) {
		set(tr);
		inverse();
	}
	
	public void mul(com.bulletphysics.linearmath.Transform tr) {
	...
	public void mul(com.bulletphysics.linearmath.Transform tr1, com.bulletphysics.linearmath.Transform tr2) {
	...
	public Quat4f getRotation(Quat4f out) {
		com.bulletphysics.linearmath.MatrixUtil.getRotation(basis, out);
		return out;
	}

	public void setRotation(Quat4f q) {
		com.bulletphysics.linearmath.MatrixUtil.setRotation(basis, q);
	}

	public void setFromOpenGLMatrix(float[] m) {
		com.bulletphysics.linearmath.MatrixUtil.setFromOpenGLSubMatrix(basis, m);
	...
	public boolean equals(Object obj) {
		if (obj == null || !(obj instanceof com.bulletphysics.linearmath.Transform)) return false;
		com.bulletphysics.linearmath.Transform tr = (com.bulletphysics.linearmath.Transform)obj;
