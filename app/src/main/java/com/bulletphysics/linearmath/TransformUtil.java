...
public class TransformUtil {
	...
	public static void integrateTransform(com.bulletphysics.linearmath.Transform curTrans, Vector3f linvel, Vector3f angvel, float timeStep, com.bulletphysics.linearmath.Transform predictedTransform) {
...
//  #endif
	...
	public static void calculateVelocity(com.bulletphysics.linearmath.Transform transform0, com.bulletphysics.linearmath.Transform transform1, float timeStep, Vector3f linVel, Vector3f angVel) {
	...
	public static void calculateDiffAxisAngle(com.bulletphysics.linearmath.Transform transform0, Transform transform1, Vector3f axis, float[] angle) {
