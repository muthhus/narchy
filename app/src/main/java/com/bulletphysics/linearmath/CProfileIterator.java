...
public class CProfileIterator {
	...
	private com.bulletphysics.linearmath.CProfileNode currentParent;
	private com.bulletphysics.linearmath.CProfileNode currentChild;

	CProfileIterator(com.bulletphysics.linearmath.CProfileNode start) {
		currentParent = start;
