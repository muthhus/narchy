...
public class ArrayPool<T> {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> com.bulletphysics.util.ArrayPool<T> get(Class cls) {
		Map map = threadLocal.get();
		
		com.bulletphysics.util.ArrayPool<T> pool = (com.bulletphysics.util.ArrayPool<T>)map.get(cls);
		if (pool == null) {
			pool = new com.bulletphysics.util.ArrayPool<T>(cls);
			map.put(cls, pool);
		}
