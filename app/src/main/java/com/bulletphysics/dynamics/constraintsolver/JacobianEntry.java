...
public class JacobianEntry {
	 ...
	 */
	public float getNonDiagonal(com.bulletphysics.dynamics.constraintsolver.JacobianEntry jacB, float massInvA) {
		com.bulletphysics.dynamics.constraintsolver.JacobianEntry jacA = this;
	 ...
	 */
	public float getNonDiagonal(com.bulletphysics.dynamics.constraintsolver.JacobianEntry jacB, float massInvA, float massInvB) {
		com.bulletphysics.dynamics.constraintsolver.JacobianEntry jacA = this;
