...
public class DbvtAabbMm {
	...
	public DbvtAabbMm(com.bulletphysics.collision.broadphase.DbvtAabbMm o) {
		set(o);
	}
	
	public void set(com.bulletphysics.collision.broadphase.DbvtAabbMm o) {
		mi.set(o.mi);
		mx.set(o.mx);
	}
	
	public static void swap(com.bulletphysics.collision.broadphase.DbvtAabbMm p1, com.bulletphysics.collision.broadphase.DbvtAabbMm p2) {
	...
	public static com.bulletphysics.collision.broadphase.DbvtAabbMm FromCE(Vector3f c, Vector3f e, com.bulletphysics.collision.broadphase.DbvtAabbMm out) {
		com.bulletphysics.collision.broadphase.DbvtAabbMm box = out;
		box.mi.sub(c, e);
		box.mx.add(c, e);
		return box;
	}

	public static com.bulletphysics.collision.broadphase.DbvtAabbMm FromCR(Vector3f c, float r, com.bulletphysics.collision.broadphase.DbvtAabbMm out) {
		Vector3f tmp = new Vector3f();
		tmp.set(r, r, r);
		return FromCE(c, tmp, out);
	}

	public static com.bulletphysics.collision.broadphase.DbvtAabbMm FromMM(Vector3f mi, Vector3f mx, com.bulletphysics.collision.broadphase.DbvtAabbMm out) {
		com.bulletphysics.collision.broadphase.DbvtAabbMm box = out;
		box.mi.set(mi);
		box.mx.set(mx);
		return box;
	...
	public boolean Contain(com.bulletphysics.collision.broadphase.DbvtAabbMm a) {
		return ((mi.x <= a.mi.x) &&
		        (mi.y <= a.mi.y) &&
		        (mi.z <= a.mi.z) &&
		        (mx.x >= a.mx.x) &&
	...
	public static boolean Intersect(com.bulletphysics.collision.broadphase.DbvtAabbMm a, com.bulletphysics.collision.broadphase.DbvtAabbMm b) {
	...
	public static boolean Intersect(com.bulletphysics.collision.broadphase.DbvtAabbMm a, com.bulletphysics.collision.broadphase.DbvtAabbMm b, Transform xform) {
	...
	public static boolean Intersect(com.bulletphysics.collision.broadphase.DbvtAabbMm a, Vector3f org, Vector3f invdir, int[] signs) {
	...
	public static float Proximity(com.bulletphysics.collision.broadphase.DbvtAabbMm a, com.bulletphysics.collision.broadphase.DbvtAabbMm b) {
	...
	public static void Merge(com.bulletphysics.collision.broadphase.DbvtAabbMm a, com.bulletphysics.collision.broadphase.DbvtAabbMm b, com.bulletphysics.collision.broadphase.DbvtAabbMm r) {
		for (int i=0; i<3; i++) {
	...
	public static boolean NotEqual(com.bulletphysics.collision.broadphase.DbvtAabbMm a, com.bulletphysics.collision.broadphase.DbvtAabbMm b) {
