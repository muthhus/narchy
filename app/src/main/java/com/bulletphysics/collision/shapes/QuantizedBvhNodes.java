...
public class QuantizedBvhNodes implements Serializable {
	...
	public void set(int destId, com.bulletphysics.collision.shapes.QuantizedBvhNodes srcNodes, int srcId) {
		assert (STRIDE == 4);
	...
	public int getTriangleIndex(int nodeId) {
		...
		return (getEscapeIndexOrTriangleIndex(nodeId) & ~((~0) << (31 - com.bulletphysics.collision.shapes.OptimizedBvh.MAX_NUM_PARTS_IN_BITS)));
	}
