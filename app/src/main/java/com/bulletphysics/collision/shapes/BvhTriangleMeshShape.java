...
public class BvhTriangleMeshShape extends TriangleMeshShape {
	...
	private com.bulletphysics.collision.shapes.OptimizedBvh bvh;
	...
	public BvhTriangleMeshShape(StridingMeshInterface meshInterface, boolean useQuantizedAabbCompression, boolean buildBvh) {
		...
		if (buildBvh) {
			bvh = new com.bulletphysics.collision.shapes.OptimizedBvh();
	...
	public com.bulletphysics.collision.shapes.OptimizedBvh getOptimizedBvh() {
		return bvh;
	}

	public void setOptimizedBvh(com.bulletphysics.collision.shapes.OptimizedBvh bvh) {
