...
public class OptimizedBvh implements Serializable {
	...
	private static class NodeTriangleCallback extends com.bulletphysics.collision.shapes.InternalTriangleIndexCallback {
	...
	private static class QuantizedNodeTriangleCallback extends InternalTriangleIndexCallback {
		...
		public com.bulletphysics.collision.shapes.OptimizedBvh optimizedTree; // for quantization

		public QuantizedNodeTriangleCallback(QuantizedBvhNodes triangleNodes, com.bulletphysics.collision.shapes.OptimizedBvh tree) {
			this.triangleNodes = triangleNodes;
