...
/**
 * ShapeHull takes a {@link com.bulletphysics.collision.shapes.ConvexShape}, builds the convex hull using {@link HullLibrary}
...
public class ShapeHull {
	...
	protected com.bulletphysics.collision.shapes.ConvexShape shape;

	protected ObjectArrayList<Vector3f> unitSpherePoints = new ObjectArrayList<Vector3f>();

	public ShapeHull(com.bulletphysics.collision.shapes.ConvexShape shape) {
		this.shape = shape;
		this.vertices.clear();
		this.indices.clear();
		this.numIndices = 0;
