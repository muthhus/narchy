...
public class ConvexConcaveCollisionAlgorithm extends CollisionAlgorithm {
	...
	private com.bulletphysics.collision.dispatch.ConvexTriangleCallback btConvexTriangleCallback;

	public void init(CollisionAlgorithmConstructionInfo ci, CollisionObject body0, CollisionObject body1, boolean isSwapped) {
		super.init(ci);
		this.isSwapped = isSwapped;
		this.btConvexTriangleCallback = new com.bulletphysics.collision.dispatch.ConvexTriangleCallback(dispatcher, body0, body1, isSwapped);
	}
	...
	public static class CreateFunc extends CollisionAlgorithmCreateFunc {
		...
		public CollisionAlgorithm createCollisionAlgorithm(CollisionAlgorithmConstructionInfo ci, CollisionObject body0, CollisionObject body1) {
			com.bulletphysics.collision.dispatch.ConvexConcaveCollisionAlgorithm algo = new com.bulletphysics.collision.dispatch.ConvexConcaveCollisionAlgorithm();
