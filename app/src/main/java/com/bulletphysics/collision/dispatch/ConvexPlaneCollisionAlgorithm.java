...
public class ConvexPlaneCollisionAlgorithm extends CollisionAlgorithm {
	...
	@Override
	public void processCollision(CollisionObject body0, CollisionObject body1, DispatcherInfo dispatchInfo, com.bulletphysics.collision.dispatch.ManifoldResult resultOut) {
		if (manifoldPtr == null) {
			return;
		}
	...
	public static class CreateFunc extends CollisionAlgorithmCreateFunc {
		...
		public CollisionAlgorithm createCollisionAlgorithm(CollisionAlgorithmConstructionInfo ci, CollisionObject body0, CollisionObject body1) {
			com.bulletphysics.collision.dispatch.ConvexPlaneCollisionAlgorithm algo = new com.bulletphysics.collision.dispatch.ConvexPlaneCollisionAlgorithm();
			if (!swapped) {
