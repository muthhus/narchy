...
public class ManifoldResult extends DiscreteCollisionDetectorInterface.Result {
	...
	private com.bulletphysics.collision.dispatch.CollisionObject body0;
	private com.bulletphysics.collision.dispatch.CollisionObject body1;
	private int partId0;
	private int partId1;
	private int index0;
	private int index1;
	...
	public ManifoldResult(com.bulletphysics.collision.dispatch.CollisionObject body0, com.bulletphysics.collision.dispatch.CollisionObject body1) {
		init(body0, body1);
	}

	public void init(com.bulletphysics.collision.dispatch.CollisionObject body0, com.bulletphysics.collision.dispatch.CollisionObject body1) {
		this.body0 = body0;
		this.body1 = body1;
    ...
    public void addContactPoint(Vector3f normalOnBInWorld, Vector3f pointInWorld, float depth) {
		...
		if (BulletGlobals.getContactAddedCallback() != null &&
			...
			com.bulletphysics.collision.dispatch.CollisionObject obj0 = isSwapped ? body1 : body0;
			com.bulletphysics.collision.dispatch.CollisionObject obj1 = isSwapped ? body0 : body1;
	...
	private static float calculateCombinedFriction(com.bulletphysics.collision.dispatch.CollisionObject body0, com.bulletphysics.collision.dispatch.CollisionObject body1) {
	...
	private static float calculateCombinedRestitution(com.bulletphysics.collision.dispatch.CollisionObject body0, CollisionObject body1) {
