...
public class CollisionObject<X> {
	...
	public boolean checkCollideWithOverride(com.bulletphysics.collision.dispatch.CollisionObject co) {
		return true;
	}
	...
	public boolean checkCollideWith(com.bulletphysics.collision.dispatch.CollisionObject co) {
		if (checkCollideWith) {
