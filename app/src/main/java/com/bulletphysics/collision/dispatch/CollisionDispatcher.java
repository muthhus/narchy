...
public class CollisionDispatcher extends Dispatcher {
	...
	private static class CollisionPairCallback extends OverlapCallback {
		...
		private com.bulletphysics.collision.dispatch.CollisionDispatcher dispatcher;

		public void init(DispatcherInfo dispatchInfo, com.bulletphysics.collision.dispatch.CollisionDispatcher dispatcher) {
