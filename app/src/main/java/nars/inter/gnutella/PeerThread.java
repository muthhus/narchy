...
public class PeerThread implements Runnable {
    ...
    public final InetSocketAddress inSktA;
     ...
     */
    public PeerThread(Map<String, Message> messageCache, Socket socket, Client client, InetSocketAddress inSkA) {
    ...
    public boolean mine(Message m) {
        return m.recipient.equals(inSktA);
    }
