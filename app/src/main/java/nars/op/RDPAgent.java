...
//
//        new RemoteConnection("localhost", 32769, "admin");
//    }
//
//    /**
...
//
//            config.securityProperty().set( (password!=null) ? SecurityType.VNC_Auth : SecurityType.NONE );
...
//            Thread t = new Thread(() -> {
//                try {
//                    RemoteConnection rc = new RemoteConnection("localhost", 32769, "admin") {
//
