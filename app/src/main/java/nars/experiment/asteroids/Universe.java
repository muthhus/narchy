...
import nars.experiment.asteroids.activities.GoodieField;
import org.apache.log4j.Logger;

import nars.experiment.asteroids.pilots.KeyboardPilot;
import nars.experiment.asteroids.pilots.EmptyCockpit;
import nars.experiment.asteroids.gui.MapMarker;
...
public class Universe extends Observable implements Runnable {
    ...
    public void initialize() {
        ...
        Universe.get().addActivity(new FactoryBattle(), 100, 100);
        Universe.get().addActivity(new GoodieField(), 0, 0);



        Ship s = Ship.get("monoship");
        s.setPosition(0, 0, 0);
        s.setFaction("Humans");
        setPlayer(s);
