package nars.experiment.asteroids.audio;
...
import nars.experiment.asteroids.sounds.*;
...
public class MinimWrapper {
    ...
    public static void addEffect(VolumeEffect volumeEffect) {

    }

    public static void addEffect(AudioEffect warbleEffect) {
