...
//
//                rawNumericSensor(new FloatNormalized(() ->
...
//        FloatPolarNormalized p = new FloatPolarNormalized(input);
...
//        FloatNormalized p = new FloatNormalized(input);
//        return new FuzzyScalar(p, n, states).pri(pri).resolution(0.1f);
////				"(" + term + " , " + low + ")",
////				"(" + term + " , " + mid + ")",
////				"(" + term + " , " + high +")").pri(pri).resolution(0.07f);
