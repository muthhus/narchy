...
package bulletphys.dynamics.constraintsolver;

import bulletphys.BulletGlobals;
import bulletphys.BulletStats;
import bulletphys.ContactDestroyedCallback;
import bulletphys.collision.broadphase.Dispatcher;
import bulletphys.collision.dispatch.CollisionObject;
import bulletphys.collision.narrowphase.ManifoldPoint;
...
import bulletphys.linearmath.MiscUtil;
import bulletphys.linearmath.Transform;
import bulletphys.linearmath.TransformUtil;
import bulletphys.util.IntArrayList;
...
public class SequentialImpulseConstraintSolver extends ConstraintSolver {
	 ...
	 */
	@Override
	public float solveGroup(ObjectArrayList<CollisionObject> bodies, int numBodies, ObjectArrayList<PersistentManifold> manifoldPtr, int manifold_offset, int numManifolds, ObjectArrayList<TypedConstraint> constraints, int constraints_offset, int numConstraints, ContactSolverInfo infoGlobal, Dispatcher dispatcher) {
