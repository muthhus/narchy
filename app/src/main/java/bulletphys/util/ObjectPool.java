...
//	public static <T> com.bulletphysics.util.ObjectPool<T> get(Class<T> cls) {
//		Map map = threadLocal.get();
//
//		com.bulletphysics.util.ObjectPool<T> pool = (com.bulletphysics.util.ObjectPool<T>)map.get(cls);
//		if (pool == null) {
//			pool = new com.bulletphysics.util.ObjectPool<T>(cls);
//			map.put(cls, pool);
//		}
//
//		return pool;
