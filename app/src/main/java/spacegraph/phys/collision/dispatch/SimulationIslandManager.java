...
public class SimulationIslandManager {
	...
	private final ObjectArrayList<Collidable> islandBodies = new ObjectArrayList<Collidable>();
	...
	public final void updateActivationState(CollisionWorld<?> colWorld, Dispatcher dispatcher) {
	...
	public final void storeIslandActivationState(CollisionWorld<?> world) {
	...
	public void buildIslands(Dispatcher dispatcher, List<Collidable> collidables) {
	...
	public void buildAndProcessIslands(Dispatcher dispatcher, List<Collidable> collidables, IslandCallback callback) {
		buildIslands(dispatcher, collidables);
	...
	public static abstract class IslandCallback {
		public abstract void processIsland(ObjectArrayList<Collidable> bodies, int numBodies, ObjectArrayList<PersistentManifold> manifolds, int manifolds_offset, int numManifolds, int islandId);
	}
