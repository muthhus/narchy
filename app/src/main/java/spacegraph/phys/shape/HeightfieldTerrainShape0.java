...
public class HeightfieldTerrainShape0 extends ConcaveShape {

	public static final int XAXIS = 0;
	public static final int YAXIS = 1;
	public static final int ZAXIS = 2;

	protected v3 m_localAabbMin = new v3();
	protected v3 m_localAabbMax = new v3();
	protected v3 m_localOrigin = new v3();
	...
	protected v3 m_localScaling = new v3();

	public HeightfieldTerrainShape0(int heightStickWidth, int heightStickLength, float[] heightfieldData, float heightScale, float minHeight, float maxHeight, int upAxis, boolean flipQuadEdges) {
	...
	@Override
	public void calculateLocalInertia(float arg0, v3 inertia) {
	...
	@Override
	public v3 getLocalScaling(v3 arg0) {
	 ...
	 */
	private static void quantizeWithClamp(int[] out, v3 clampedPoint) {
