...
public class Generic6DofSpringConstraint extends Generic6DofConstraint {
	...
	int i;
        ...
        v3 velA = rbA.getLinearVelocity( new v3() );
        v3 velB = rbB.getLinearVelocity( new v3() );
...
public void setAxis(v3 axis1, v3 axis2)
{
	v3 zAxis = new v3(axis1);
        zAxis.normalize();

        v3 yAxis = new v3(axis2);
        zAxis.normalize();
