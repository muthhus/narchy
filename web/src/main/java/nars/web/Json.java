...
public class Json {
    ...
    static {
        ...
        jsonizer.setStreamCoderFactory(new FastJsonStreamCoderFactory(jsonizer));
    ...
    static class FastJsonStreamCoderFactory implements FSTConfiguration.StreamCoderFactory {
        ...
        public FastJsonStreamCoderFactory(FSTConfiguration conf) {
            this.conf = conf;
        }

        @Override
        public FSTEncoder createStreamEncoder() {
            return new MyFSTJsonEncoder(conf);
        }

        @Override
        public FSTDecoder createStreamDecoder() {
            return new FSTJsonDecoder(conf); //TODO this will be incompatible with the encoder
        }
    ...
    /**
     * customization of FSTJsonEncoder with option to remove typing metadata, etc
     */
    public static class MyFSTJsonEncoder implements FSTEncoder {
        ...
        public MyFSTJsonEncoder(FSTConfiguration conf) {
            this.conf = conf;
