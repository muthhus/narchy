...
@ThreadLeakLingering(linger = 4000) // Wait long for leaked threads to complete before failure. zk needs this.
...
public abstract class LuceneTestCase extends Assert {
    ...
    public static final String DEFAULT_LINE_DOCS_FILE =
            "/home/me/lucene-solr/lucene/test-framework/src/resources/org/apache/lucene/util/" + //HACK
     ...
     */
    private final TestRuleSetupTeardownChained parentChainCallRule = new TestRuleSetupTeardownChained();
  ...
  public static SegmentReader getOnlySegmentReader(DirectoryReader reader) {
    ...
    */
    ...
    public static Path addVirusChecker(Path path) {
        if (TestUtil0.hasVirusChecker(path) == false) {
    ...
    */
    ...
    private static Directory newFSDirectoryImpl(Class<? extends FSDirectory> clazz, Path path, LockFactory lf) {
        FSDirectory d = null;
        try {
            ...
            if (ex != null) {
                ...
                r.addReaderClosedListener(new ReaderClosedListener() {
                    ...
                    public void onClose(IndexReader reader) {
                        TestUtil0.shutdownExecutorService(ex);
                    }
                });
            }
            IndexSearcher ret;
                ...
                if (code == 0) {
                    ...
                    switch (random().nextInt(3)) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            tests.add(new BytesRef(TestUtil0.randomSimpleString(random()))); // random term
                            break;
                        default:
                            throw new AssertionError();
                    }
