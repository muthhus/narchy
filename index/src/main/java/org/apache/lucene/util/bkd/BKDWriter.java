...
public class BKDWriter implements Closeable {
    ...
    private long writeField1Dim(IndexOutput out, String fieldName, MutablePointValues reader) throws IOException {
        ...
        reader.intersect(new MyIntersectVisitor(oneDimWriter));
    ...
    private static class MyIntersectVisitor implements IntersectVisitor {

        private final OneDimensionBKDWriter oneDimWriter;

        public MyIntersectVisitor(OneDimensionBKDWriter oneDimWriter) {
  ...
  */
    ...
    private byte[] packIndex(long[] leafBlockFPs, byte[] splitPackedValues) throws IOException {
        ...
        List<byte[]> blocks = new FasterList<>();
     ...
     */
    private static int appendBlock(RAMOutputStream writeBuffer, List<byte[]> blocks) throws IOException {
