...
public class Automaton extends BitSet implements Accountable {
...
//    }
    ...
    public void copy(Automaton other) {
        ...
        BitSet otherAcceptStates = other;
        int state = 0;
  ...
  */
    ...
    public long ramBytesUsed() {
        ...
        return RamUsageEstimator.NUM_BYTES_OBJECT_HEADER + RamUsageEstimator.sizeOf(states) + RamUsageEstimator.sizeOf(transitions) +
                RamUsageEstimator.NUM_BYTES_OBJECT_HEADER + (size() / 8) + RamUsageEstimator.NUM_BYTES_OBJECT_REF +
