...
public final class Term extends BytesRef {

    final String field;

//    @Deprecated
//    final BytesRef bytes = this;
    ...
    public Term(String fld, BytesRefBuilder bytesBuilder) {
        this(fld, bytesBuilder.toBytesRef());
    }
     ...
     */
    @Deprecated public final BytesRef bytes() {
        return this;
    }
    ...
    public final int compareTo(BytesRef other) {
        ...
        if (!(other instanceof Term)) {
            ...
            if (field.equals(t.field)) {
                ...
                return field.compareTo(t.field);
            }
