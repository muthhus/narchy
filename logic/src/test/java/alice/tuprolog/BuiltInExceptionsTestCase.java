...
public class BuiltInExceptionsTestCase extends TestCase {
	...
	public void test_asserta_1_1() throws Exception {
		...
		Assert.assertTrue(g.isEqual(new Struct("asserta", new Var("X"))));
	...
	public void test_asserta_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("asserta", new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	...
	public void test_$retract_1_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$retract", new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_$retract_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$retract", new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
		Assert.assertTrue(validType.isEqual(new Struct("clause")));
	...
	public void test_abolish_1_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("abolish", new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_abolish_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("abolish", new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
		Assert.assertTrue(validType.isEqual(new Struct("predicate_indicator")));
		Int culprit = (Int) info.getTerm("Culprit");
		assertEquals(1, culprit.intValue());
	}
	...
	public void test_abolish_1_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("abolish",
		...
		Assert.assertTrue(culprit.isEqual(new Struct("p", new Var("X"))));
	}
	...
	public void test_halt_1_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("halt", new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_halt_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("halt", new Double(1.5))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_load_library_1_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("load_library", new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_load_library_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("load_library", new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_load_library_1_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("load_library", new Struct("a"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ObjectType");
		Assert.assertTrue(validType.isEqual(new Struct("class")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("a")));
		Term message = info.getTerm("Message");
		Assert.assertTrue(message.isEqual(new Struct("InvalidLibraryException: a at -1:-1")));
	}
	...
	public void test_unload_library_1_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("unload_library", new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_unload_library_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("unload_library", new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
		Assert.assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_unload_library_1_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("unload_library", new Struct("a"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ObjectType");
		Assert.assertTrue(validType.isEqual(new Struct("class")));
		...
		Assert.assertTrue(culprit.isEqual(new Struct("a")));
		Term message = info.getTerm("Message");
		Assert.assertTrue(message.isEqual(new Struct("InvalidLibraryException: null at 0:0")));
	}
	...
	public void test_$call_1_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$call", new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_$call_1_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$call", new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_is_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("is", new Var("X"), new Var("Y"))));
		Int argNo = (Int) info.getTerm("ArgNo");
	...
	public void test_is_2_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("is", new Var("X"), new Struct("a"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_is_2_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("is", new Var("X"), new Struct("/", new Int(1), new Int(0)))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct error = (Struct) info.getTerm("Error");
		Assert.assertTrue(error.isEqual(new Struct("zero_divisor")));
	}
	...
	public void test_is_2_5() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("is", new Var("X"), new Struct("div", new Int(1), new Int(0)))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct error = (Struct) info.getTerm("Error");
		Assert.assertTrue(error.isEqual(new Struct("zero_divisor")));
	...
	public void test_$tolist_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$tolist", new Var("X"),
				new Var("List"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_$fromlist_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$fromlist", new Var("Struct"),
				new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
	}
	...
	public void test_$append_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$append", new Struct("a"),
				new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
	}
	...
	public void test_$append_2_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$append", new Struct("a"), new Struct(
				"b"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
		Assert.assertTrue(validType.isEqual(new Struct("list")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("b")));
	}
	...
	public void test_$find_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$find", new Var("X"), new Struct())));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_$find_2_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$find", new Struct("p", new Var("X")),
				new Struct("a"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_set_prolog_flag_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("set_prolog_flag", new Var("X"),
				new Int(1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_set_prolog_flag_2_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("set_prolog_flag", new Struct("a"),
				new Var("X"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
	}
	...
	public void test_set_prolog_flag_2_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("set_prolog_flag", new Int(1), new Int(
				1))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_set_prolog_flag_2_4() throws Exception {
		...
		assertEquals(2, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
		Assert.assertTrue(validType.isEqual(new Struct("ground")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("p", new Var("X"))));
	}
	...
	public void test_set_prolog_flag_2_5() throws Exception {
		...
		Assert.assertTrue(validDomain.isEqual(new Struct("prolog_flag")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("a")));
	}
	...
	public void test_set_prolog_flag_2_6() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("set_prolog_flag",
				new Struct("bounded"), new Struct("a"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct validDomain = (Struct) info.getTerm("ValidDomain");
		Assert.assertTrue(validDomain.isEqual(new Struct("flag_value")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("a")));
	}
	...
	public void test_set_prolog_flag_2_7() throws Exception {
		...
		Assert.assertTrue(operation.isEqual(new Struct("modify")));
		Struct objectType = (Struct) info.getTerm("ObjectType");
		Assert.assertTrue(objectType.isEqual(new Struct("flag")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("bounded")));
		Term message = info.getTerm("Message");
		Assert.assertTrue(message.isEqual(new Int(0)));
	}
	...
	public void test_get_prolog_flag_2_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("get_prolog_flag", new Var("X"),
				new Var("Value"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_get_prolog_flag_2_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("get_prolog_flag", new Int(1), new Var(
				"Value"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_get_prolog_flag_2_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("get_prolog_flag", new Struct("a"),
				new Var("Value"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validDomain = (Struct) info.getTerm("ValidDomain");
	...
	public void test_$op_3_1() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Var("Priority"), new Struct(
				"yfx"), new Struct("+"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
	}
	...
	public void test_$op_3_2() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Int(600), new Var(
	...
	public void test_$op_3_3() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Int(600), new Struct("yfx"),
				new Var("Operator"))));
		Int argNo = (Int) info.getTerm("ArgNo");
	...
	public void test_$op_3_4() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Struct("a"), new Struct(
				"yfx"), new Struct("+"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_$op_3_5() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Int(600), new Int(1),
				new Struct("+"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_$op_3_6() throws Exception {
		...
		assertEquals(3, argNo.intValue());
		Struct validType = (Struct) info.getTerm("ValidType");
		Assert.assertTrue(validType.isEqual(new Struct("atom_or_atom_list")));
		Int culprit = (Int) info.getTerm("Culprit");
		assertEquals(1, culprit.intValue());
	}
	...
	public void test_$op_3_7() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Int(1300),
				new Struct("yfx"), new Struct("+"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(1, argNo.intValue());
		Struct validDomain = (Struct) info.getTerm("ValidDomain");
		Assert.assertTrue(validDomain.isEqual(new Struct("operator_priority")));
		Int culprit = (Int) info.getTerm("Culprit");
	...
	public void test_$op_3_8() throws Exception {
		...
		Assert.assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		Assert.assertTrue(g.isEqual(new Struct("$op", new Int(600), new Struct("a"),
				new Struct("+"))));
		Int argNo = (Int) info.getTerm("ArgNo");
		assertEquals(2, argNo.intValue());
		Struct validDomain = (Struct) info.getTerm("ValidDomain");
		Assert.assertTrue(validDomain.isEqual(new Struct("operator_specifier")));
		Struct culprit = (Struct) info.getTerm("Culprit");
		Assert.assertTrue(culprit.isEqual(new Struct("a")));
	}
