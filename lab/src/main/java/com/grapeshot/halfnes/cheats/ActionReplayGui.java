...
public class ActionReplayGui extends javax.swing.JDialog {
    ...
    public ActionReplayGui(java.awt.Frame parent, boolean modal, ActionReplay actionReplay) {
        ...
        listPossibleAddresses.addListSelectionListener(e -> {
    ...
    private void updateCurrentCodesList() {
        java.util.Collection<Patch> var = actionReplay.getPatches().values();
        final Patch[] patches = var.toArray(new Patch[var.size()]);
    ...
    private static long GGtoHex(String code) {
    ...
    private void initComponents() {
        ...
        textCode.addCaretListener(this::textCodeCaretUpdate);
        ...
        btnRemoveAll.addActionListener(this::btnRemoveAllActionPerformed);
        ...
        textFindData.addCaretListener(this::textFindDataCaretUpdate);
        ...
        btnTry.setText("Try");
        btnTry.setEnabled(false);
        btnTry.addActionListener(this::btnTryActionPerformed);
