...
public class OnScreenMenu extends StackPane {
    ...
    private final ListView<MenuAction> menu;
    private ListView<MenuAction> gameMenu = null;
    ...
    private final ObservableList<MenuAction> games;

    public OnScreenMenu(GUIInterface gui) {
        this.gui = gui;
        menu = new ListView<>(menuItems);

        games = FXCollections.<MenuAction>observableArrayList(
    ...
    private static List<String> listRomsInZip(String zipName) throws IOException {
