...
public class ControllerImpl implements ControllerInterface, KeyListener {
    ...
    public ControllerImpl(final Scene scene, final int controllernum) {
        this(controllernum);
        scene.addEventHandler(javafx.scene.input.KeyEvent.KEY_PRESSED, e -> pressKey(e.getCode().getCode()));
        scene.addEventHandler(javafx.scene.input.KeyEvent.KEY_RELEASED, e -> releaseKey(e.getCode().getCode()));
    }
...
//        }
    ...
    private static boolean isPressed(Event event) {
        Component component = event.getComponent();
    ...
    private static Controller[] getAvailablePadControllers() {
        ...
        return gameControllers.toArray(new Controller[gameControllers.size()]);
    }
    ...
    private static Component[] getButtons(Controller controller) {
        ...
        return buttons.toArray(new Component[buttons.size()]);
    }
