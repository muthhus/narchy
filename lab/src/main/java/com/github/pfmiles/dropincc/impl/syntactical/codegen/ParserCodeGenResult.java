...
public class ParserCodeGenResult {
     ...
     */
    private Map<String, TokenType> fieldTokenTypeMapping = new HashMap<>();

    /*
     * generated parser class field's name to alts action mapping
     */
    private Map<String, Object> fieldAltsActionMapping = new HashMap<>();

    /*
     * generated parser class field's name to semantic predicate mapping
     */
    private Map<String, Predicate<?>> fieldPredsMapping = new HashMap<>();

    /*
     * generated parser class field's name to rule dfa mapping
     */
    private Map<String, RunningDfaState> fieldRuleDfaMapping = new HashMap<>();

    /*
     * generated parser class field's name to kleene nodes' look ahead dfa
     * mapping
     */
    private Map<String, RunningDfaState> fieldKleeneDfaMapping = new HashMap<>();
