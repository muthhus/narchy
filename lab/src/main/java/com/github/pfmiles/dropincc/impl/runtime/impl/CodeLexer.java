...
public class CodeLexer extends Lexer {
    ...
    private final Map<Integer, TokenType> groupNumToType;
    // scanning code
    ...
    private final Deque<Integer[]> savePoints = new ArrayDeque<>();

    // matched token backup when any save point is set
    private final ArrayList<Token> backUp = new ArrayList<>();
