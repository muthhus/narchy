...
abstract public class RoverWorld implements LayerDraw {
	...
	public void addFood(World2D world, float w, float h, float minSize, float maxSize,
	...
	public Body addWall(World2D world, float x, float y, float w, float h, float a) {
