...
public abstract class EmitterSettings {
	...
	/** X/Y scatter amount */
	xLocationVariance, yLocationVariance,

	/** Info for particle in physics world */
	particleFriction, particleRestitution, particleDensity,
	...
	/**
	 * Called by the emitter after every particle is made, to allow for changing
	 * settings
	 */
