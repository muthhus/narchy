...
import static objenome0.util.bean.anno.PropertyChangeEventMethod.Type.ADD_LISTENER;
import static objenome0.util.bean.anno.PropertyChangeEventMethod.Type.REMOVE_LISTENER;
