package objenome0.util.bean.util;

import objenome0.util.bean.anno.PropertyChangeEventMethod;

import java.beans.VetoableChangeListener;

import static objenome0.util.bean.anno.PropertyChangeEventMethod.Type.ADD_VETO_LISTENER;
import static objenome0.util.bean.anno.PropertyChangeEventMethod.Type.REMOVE_VETO_LISTENER;
