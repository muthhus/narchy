...
import objenome0.util.bean.anno.GenericBeanKeyMethod;
import objenome0.util.bean.anno.GenericBeanKeyProvider;
import objenome0.util.bean.anno.GenericBeanMethod;
...
import static objenome0.util.bean.anno.GenericBeanMethod.Type.*;
