...
/**
 * A node which performs the inverse trigonometric function of arc-cotangent,
 * called ARCCOT
 *
 * @since 2.0
 */
public class ArcCotangent extends Node {
     ...
     * arc-cotangent of this value becomes the result of this method as a double
     * value.
     *
    ...
    public Double evaluate() {
        ...
        return arccot(NumericUtils.asDouble(c));
    }
