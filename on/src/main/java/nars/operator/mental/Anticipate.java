...
//    }
   ...
   //  *
    ...
    boolean anticipationOperator; //a parameter which tells whether NARS should know if it anticipated or not
    ...
    public void anticipate(Term content, Memory memory, long occurenceTime, Task t) {
       ...
       if(t != null) {
        ...
        if(anticipationOperator) {
            Operation op=(Operation) Inheritance.make(Product.make(content), this);
