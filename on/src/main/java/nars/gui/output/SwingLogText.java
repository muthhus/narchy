        ...
        if (c!=OUT.class) {
            ...
            if (o instanceof Task) {
                ...
                if (s!=null) {
                    ...
                    if (tv!=null) {          
                        float evidence = UtilityFunctions.c2w(tv.getConfidence());
                        float pos_2 = tv.getConfidence()*tv.getFrequency();
                        float positive_evidence_in_0_1 = UtilityFunctions.w2c(evidence * tv.getFrequency());
                        float negative_evidence_in_0_1 = UtilityFunctions.w2c(evidence * (1.0f - tv.getFrequency()));
                        ...
                        float evidence = UtilityFunctions.c2w(t.getBestSolution().truth.getConfidence());
                        float pos_2 = t.getBestSolution().truth.getConfidence()*t.getBestSolution().truth.getFrequency();
                        float positive_evidence_in_0_1 = UtilityFunctions.w2c(evidence * t.getBestSolution().truth.getFrequency());
                        float negative_evidence_in_0_1 = UtilityFunctions.w2c(evidence * (1.0f - t.getBestSolution().truth.getFrequency()));
