...
public class Parameters {
    ...
    public static boolean SHOW_REASONING_ERRORS; //currently false because the sentence constructor is the only one
    ...
    public static boolean DEBUG_BAG;
   ...
   // public static int STM_SIZE = 1;
    ...
    public static boolean CURIOSITY_FOR_OPERATOR_ONLY; //for Peis concern that it may be overkill to allow it for all <a =/> b> statement, so that a has to be an operator
    public static boolean CURIOSITY_ALSO_ON_LOW_CONFIDENT_HIGH_PRIORITY_BELIEF;
    ...
    public static boolean REFLECT_META_HAPPY_GOAL;
    public static boolean CONSIDER_REMIND;
    public static boolean BREAK_NAL_HOL_BOUNDARY;
    
    public static boolean QUESTION_GENERATION_ON_DECISION_MAKING;
    ...
    public static float SATISFACTION_TRESHOLD; //decision threshold is enough for now
