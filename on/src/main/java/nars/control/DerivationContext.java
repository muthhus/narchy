...
public class DerivationContext {
    ...
    public interface DerivationFilter extends Plugin {
        ...
        String reject(DerivationContext nal, Task task, boolean revised, boolean single, Task parent, Sentence otherBelief);
    ...
    protected List<DerivationFilter> derivationFilters;
