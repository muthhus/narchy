//package mdi;
//
//import br.com.supremeforever.mdi.PositionOutOfBoundsException;
...
//
//        // ====== Act ==========
//        TestUtil.runThenWaitForPaintPulse(() -> this.mdi.newWindow(mdiWindow, position));
//
//        // ====== Verify =======
...
//
//        // ====== Act ==========
//        TestUtil.runThenWaitForPaintPulse(() -> this.mdi.newWindow(mdiWindow));
//
//        // ====== Verify =======
...
//                new ImageView("mdi/WindowIcon.png"),
...
//            try{
//                this.mdi.newWindow(mdiWindow, position);
