...
//	protected static final boolean isOptimizeNodeDistribution = true;
     ...
     */
    protected final float minMoveRadius = 1.0f;
     ...
     */
    protected final float radiusScaleFactor = 0.9f;
     ...
     */
    protected final float fineTuningRadius = 40.0f;
     ...
     */
    protected final float edgeDistanceCostFactor = 3000.0f;
     ...
     */
    protected final float edgeCrossingCostFactor = 6000.0f;
     ...
     */
    protected final float nodeDistributionCostFactor = 30000.0f;
     ...
     */
    protected final float borderLineCostFactor = 5.0f;
     ...
     */
    protected final float edgeLengthCostFactor = 0.02f;
     ...
     * terminates
     */
    protected final int unchangedEnergyRoundTermination = 5;
     ...
     */
    protected final boolean approxNodeDimensions = true;
     ...
     */
    protected final List<CellWrapper<TermEdge>> e = new FasterList();
...
//		}
    ...
    final Rectangle2D.Float unit = new Rectangle2D.Float(-32.0f, -32.0f, 32.0f, 32.0f);
