...
public class BeliefLab {
	...
	static float conf = 0.85f;
	static float predictionProbability = 0.05f; // how often to ask for a
												// prediction
	static float pastProbability = 0.05f; // how often to ask for a prediction
