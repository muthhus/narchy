...
public class DockingContent {
	 ...
	 * 
	 * @param uid
	 *            String used to uniquely identify this window within the
	 *            docking system.
	 * @param title
	 *            Name of component that will be displayed in tabs
	 * @param component
	 *            The component that will be displayed in the body of the docked
	 *            window
	 */
	 ...
	 *            Name of component that will be displayed in tabs
	 * @param icon
	 *            Icon that will be displayed to the left of the title. If null,
	 *            no icon is displayed.
	 * @param component
	 *            The component that will be displayed in the body of the docked
	 *            window
	 */
	public DockingContent(String uid, String title, Icon icon,
			Component component) {
		this.uid = uid;
		this.title = title;
		this.icon = icon;
