 ...
 * @param <E>
 */
public final class SortedList_1x4<E> extends ListDecorator_1x0<E, List<E>> {

	/**
	 * creates sorted list. created sorted list is only a view on the given
	 * {@code list}, thus if you modify the {@link} you may create an instable
	 * state.
	 * 
	 * @param <E>
	 ...
	 */
	public static <E> SortedList_1x4<E> of(final List<E> list,
			final Comparator<E> comparator, final SearchType searchType,
	 ...
	 * 
	 * @param list
	 *            the list or sublist in where the index should be found
	 * @param element
	 *            element for which the index should be found
	 * @param left
	 *            the left index (inclusively)
	 * @param right
	 *            the right index (exclusively)
	 * @param rightBorder
	 *            This parameter will be modified inside the method, thus you
	 ...
	 * 
	 * @param list
	 *            the list or sublist which should be invastigated
	 * @param element
	 *            element for which the index should be found
	 * @param left
	 *            left index (inclusively)
	 * @param right
	 *            right index (exclusively)
	 * @return
	 */
