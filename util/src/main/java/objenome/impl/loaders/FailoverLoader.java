...
import static objenome.impl.loaders.GeneratedAdapters.*;
...
public final class FailoverLoader extends Loader {
   ...
   */
    ...
    private final LockedMemoizer<Class<?>, ModuleAdapter<?>> loadedAdapters =
            new LockedMemoizer<Class<?>, ModuleAdapter<?>>() {
                @Override
    ...
    @Override
    public Binding<?> getAtInjectBinding(
