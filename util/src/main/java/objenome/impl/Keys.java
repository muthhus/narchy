...
public final class Keys {
    ...
    private static final LockedMemoizer<Class<? extends Annotation>, Boolean> IS_QUALIFIER_ANNOTATION =
            new LockedMemoizer<Class<? extends Annotation>, Boolean>() {
                @Override
     ...
     * @param start          an index into the key representing the key's "real" start after
     *                       any annotations.
     * @param delegatePrefix key prefix elements extracted from the underlying delegate
