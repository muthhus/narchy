...
public final class ProblemDetector {
    public static void detectCircularDependencies(Collection<Binding<?>> bindings) {
        detectCircularDependencies(bindings, new ArrayList<>());
    }

    public static void detectUnusedBinding(Collection<Binding<?>> bindings) {
    ...
    public static void detectProblems(Collection<Binding<?>> values) {
