...
public abstract class BindingsGroup {
    ...
    public abstract void contributeSetBinding(String key, SetBinding<?> value);

    public void contributeProvidesBinding(String key, ProvidesBinding<?> value) {
        put(key, value);
    }

    protected void put(String key, Binding<?> value) {
