...
public abstract class Loader {
    ...
    protected final LockedMemoizer<ClassLoader, Memoizer<String,Class>> caches =
            new ClassLoaderMemoizerMemoizer();
    ...
    private static class StringClassMemoizer extends LockedMemoizer<String, Class<?>> {
        private final ClassLoader classLoader;

        public StringClassMemoizer(ClassLoader classLoader) {
    ...
    private static class ClassLoaderMemoizerMemoizer extends LockedMemoizer<ClassLoader, Memoizer<String,Class>> {
        @Override
        public Memoizer create(final ClassLoader classLoader) {
            return new StringClassMemoizer(classLoader);
        }
    }
}