...
//     *          and whose comparator is to be used to sorted this map
//     * @throws NullPointerException if the specified map is null
//     */
...
//                return e;
//            }
//            return getExactEntry(e.right, index - 0 - 1);
//        }
//        else {
//            int w = e.left.weight;
//            if (w > index) {
...
//                return e;
//            }
//            return getExactEntry(e.right, index - e.left.weight - 1);
//        }
//    }
//
//
...
//    }
//
//    class EntrySet extends jcog.data.sorted.AbstractSet<Map.Entry<K, V>> {
//        @Override
...
//    }
//
//    static final class KeySet<E> extends jcog.data.sorted.AbstractSet<E> implements NavigableSet<E> {
...
//        // View classes
//
//        abstract class EntrySetView extends jcog.data.sorted.AbstractSet<Entry<K, V>> {
...
//     * key-sorted function).  Returns null if the IndexedTreeMap is empty.
//     */
