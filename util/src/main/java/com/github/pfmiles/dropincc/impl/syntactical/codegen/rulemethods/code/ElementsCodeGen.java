...
public class ElementsCodeGen extends CodeGen {
    ...
    private final List<EleType> matchSeq;
    ...
    public Pair<String, String> render(CodeGenContext context) {
        ...
        for (EleType ele : this.matchSeq) {
            if (ele instanceof TokenType) {
                ...
                Pair<String, String> varAndCode = new KleeneEleGen(context.kleeneTypeToPredicting.get(ele), this.generatingBacktrackCode)
                        .render(context);
        ...
        return new Pair<>(retVar, sb.toString());
    }
}
