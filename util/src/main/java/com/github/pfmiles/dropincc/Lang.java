...
public class Lang implements Serializable {
    ...
    private final static Pattern langNamePattern = Pattern.compile("^[a-zA-Z]\\w*$");
    ...
    private final List<TokenDef> tokens = new ArrayList<>();
    private final List<Grule> grules = new ArrayList<>();
    ...
    private static void checkIfAnyEmptyGrule(List<Grule> gs) {
        for (Grule g : gs) {
