...
public class DecisionTreeFindBestSplitTest {
    ...
    public void testBooleanSplit() {
        ...
        List<List<Function<String,Object>>> split = DecisionTree.split(bestSplit, dataSet);
        ...
        List<List<Function<String,Object>>> newSplit = DecisionTree.split(newBestSplit, split.get(0));
