...
public class ImpurityCalculationMethodTest {
    ...
    public void testGetEmpiricalProbability50_50() {
        DataSample dataSample1 = SimpleDataSample.data("a", new String[]{"a"}, BooleanLabel.TRUE_LABEL);
        DataSample dataSample2 = SimpleDataSample.data("a", new String[]{"a"}, BooleanLabel.FALSE_LABEL);
