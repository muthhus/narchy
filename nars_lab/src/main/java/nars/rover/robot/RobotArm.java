...
abstract public class RobotArm extends Robotic {
	...
	// // pjd.initialize(ground, body, new Vec2(0.0f, 17.0f), new Vec2(0.0f,
	// 1.0f));
	// //
	...
	//
	// @Override
	// public void step(float timeStep, TestbedSettings settings, TestbedPanel
	// panel) {
	...
	// draw().drawSegment(point1, ccallback.m_point, new Color3f(0.8f, 0.8f,
	// 0.8f));
	// pooledHead.set(ccallback.m_normal);
	// pooledHead.mulLocal(.5f).addLocal(ccallback.m_point);
	// draw().drawSegment(ccallback.m_point, pooledHead, new Color3f(0.9f, 0.9f,
	// 0.4f));
	// hit[i]= true;
	// } else {
	...
	// }
	// public void set(float shoulderAngle, float elbowAngle, float
	// fingerLeftAngle, float fingerRightAngle) {
	// float angleTolerance = 0.05f;
	// shoulderJoint.setLimits(shoulderAngle-angleTolerance,
	// shoulderAngle+angleTolerance);
	// elbowJoint.setLimits(elbowAngle-angleTolerance,
	// elbowAngle+angleTolerance);
	// fingerLeftJoint.setLimits(fingerLeftAngle-angleTolerance,
	// fingerLeftAngle+angleTolerance);
	// fingerRightJoint.setLimits(fingerRightAngle-angleTolerance,
	// fingerRightAngle+angleTolerance);
	//
	// }
	//
	// @Override
