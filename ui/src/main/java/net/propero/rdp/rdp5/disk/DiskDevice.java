...
//
//    private final BlockingQueue<IRP> irps;
//
//    private static final boolean running = true;
//
//    private final Map<Integer, DriveFile> files;
//
...
//    }
//
//    private static int drive_process_irp_query_volume_information(RdpPacket data, IRP irp) throws IOException {
//        DataOutputStream out = irp.out;
//        int fsInformationClass = data.getLittleEndian32();
////        int length = data.getLittleEndian32();
////        data.incrementPosition(24);
...
//    }
//
//    private static int drive_process_irp_silent_ignore(RdpPacket data, IRP irp) throws IOException {
...
//    }
//
//    private static int drive_process_irp_device_control(RdpPacket data, IRP irp) throws IOException {
//        irp.out.writeInt(0);
//        return RD_STATUS_NOT_SUPPORTED;
//    }
//
...
//        synchronized RandomAccessFile getRAF(boolean write) throws IOException, FileNotFoundException {
//            if(raf == null) {
