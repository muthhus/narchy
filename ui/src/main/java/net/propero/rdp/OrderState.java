...
class OrderState {
    private final BoundsOrder bounds;
    private final DestBltOrder destblt;
    private final PatBltOrder patblt;
    private final ScreenBltOrder screenblt;
    private final LineOrder line;
    private final RectangleOrder rect;
    private final DeskSaveOrder desksave;
    private final MemBltOrder memblt;
    private final TriBltOrder triblt;
    private final PolyLineOrder polyline;
    private final Text2Order text2;
