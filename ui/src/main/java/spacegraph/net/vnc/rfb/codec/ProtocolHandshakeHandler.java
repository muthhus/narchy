...
import spacegraph.net.vnc.rfb.codec.handshaker.event.SharedEvent;
import spacegraph.net.vnc.rfb.codec.security.RfbSecurityHandshaker;
import spacegraph.net.vnc.rfb.codec.security.RfbSecurityHandshakerFactory;
import spacegraph.net.vnc.rfb.codec.security.RfbSecurityMessage;
...
public class ProtocolHandshakeHandler extends ChannelInboundHandlerAdapter {
    ...
    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws ProtocolException {
