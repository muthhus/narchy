 ...
 * the License.
 *******************************************************************************/
package spacegraph.net.vnc.rfb.codec.encoder;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import io.netty.handler.codec.MessageToMessageEncoder;
import spacegraph.net.vnc.rfb.codec.ClientEventType;
...
public class ClientCutTextEncoder extends MessageToMessageEncoder<ClientCutText> {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, ClientCutText msg, List<Object> out) {
