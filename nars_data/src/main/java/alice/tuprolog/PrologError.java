...
public class PrologError extends Throwable {
	...
	*/
	...
	public static PrologError type_error(EngineManager e, int argNo, String validType, PTerm culprit) {
	...
	public static PrologError domain_error(EngineManager e, int argNo, String validDomain, PTerm culprit) {
	...
	public static PrologError existence_error(EngineManager e, int argNo, String objectType, PTerm culprit, PTerm message) {
	...
	public static PrologError permission_error(EngineManager e, String operation, String objectType, PTerm culprit, PTerm message) {
	...
	public static PrologError resource_error(EngineManager e, PTerm resource) {
