...
abstract public class Abbreviation/*<S extends Term>*/ extends MutaTaskBag<BLink<Compound>> {
    ...
    public Abbreviation(@NotNull NAR n, String termPrefix, int volMin, float selectionRate, int capacity) {
        ...
        this.maxVol = n.compoundVolumeMax.intValue() - 2;
    }
...
//                                (threshFalloffRate) );
    ...
    public static class AbbreviationRelation extends Abbreviation {
        ...
        public AbbreviationRelation(@NotNull NAR n, String termPrefix, int volMin, float selectionRate, int capacity) {
            super(n, termPrefix, volMin, selectionRate, capacity);
        }

        @Override
        protected void abbreviate(@NotNull CompoundConcept abbreviated, Budget b) {

            String id = newCanonicalTerm(abbreviated);
            if (id == null)
                id = newSerialTerm();
    ...
    public static class AbbreviationAlias extends Abbreviation {
        public AbbreviationAlias(@NotNull NAR n, String termPrefix, int volMin, float selectionRate, int capacity) {
            super(n, termPrefix, volMin, selectionRate, capacity);
        }
