...
//
//    @Override
//    public Termed get(String id) {
//        return map.get(id);
//    }
//
//    @Override
//    public Termed getIfAbsentPut(String s, @NotNull Function<Term, ? extends Termed> conceptBuilder) {
//
...
//
//    @Override
//    public Termed getIfAbsentPut(@NotNull Atomic a, @NotNull Function<Term, ? extends Termed> conceptBuilder) {
