...
//            p *= freqFactor;
//            float eviFactor = evidencePreservationRelative(truth, d, 0f);
//            p *= eviFactor;
//
...
//            p *= (simplicityFactor * simplicityFactor); // * simplicityFactor * simplicityFactor);
//        }
//
