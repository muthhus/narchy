...
//    @NotNull
//    public final transient BoolCondition conseq;
//
//
//    public IfThen(@NotNull BoolCondition cond, @NotNull BoolCondition conseq) {
//        super(Op.IMPL,
...
//            conseq.accept(m ,
//                    m.now()/* since evaluating the bool will have added to the stack */);
//        }
//        m.revert(now);
//    }
//
