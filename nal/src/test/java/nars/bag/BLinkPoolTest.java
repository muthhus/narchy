...
public class BLinkPoolTest {
    ...
    public void test1() {
        ...
        BLinkPool<String>.BLinkI<String> b0 = p.get(0);
        BLinkPool<String>.BLinkI<String> b1 = p.get(1);
        ...
        BLinkPool<String>.BLinkI<String> b00 = p.get(0);
        assertEquals(b00.pri(), b0.pri(), 0.01f);
        BLinkPool<String>.BLinkI<String> b11 = p.get(1);
