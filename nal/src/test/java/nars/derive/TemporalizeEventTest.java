...
//    }
    ...
    public void testEventizeCrossDirETERNAL() throws Narsese.NarseseException {
        Temporalize t = new Temporalize();
        t.knowAbsolute($("((a &&+2 b) ==>-3 c)"), ETERNAL);
