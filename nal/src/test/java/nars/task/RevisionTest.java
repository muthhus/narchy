...
//                .believe(0.0f, 0.9f, Tense.Present);
    ...
    @Test public void testRevision3Eternals() throws Narsese.NarseseException {
        ...
        n.run(1);
        Task t = ((BaseConcept)n.conceptualize("(a)")).beliefs().match(ETERNAL, null, null, true, null);
    ...
    @Test public void testRevisionBudgeting() {
        ...
        assertEquals(0.5f, b.beliefs().match(ETERNAL, null, null, true, null).truth().conf(), 0.01f);
        ...
        assertEquals(0.71f, b.beliefs().match(ETERNAL, null, null, true, null).truth().conf(), 0.06f); //the revised task on top
